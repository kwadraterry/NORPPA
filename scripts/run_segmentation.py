...
def process_datasets(datasets):
    for (dataset_name, dataset, out_dataset) in datasets:
        ...
        pipeline = [compose_sequential(
                    ...
                    curry(segment, cfg["detectron_predictor"], instance_segmentation=False),
...
def main():
    ...
    datasets = [  ("norppa_database_tonemapped", 
                        SimpleDataset("/ekaterina/work/data/norppa_database_tonemapped"), 
                        "/ekaterina/work/data/norppa_database_tonemapped_segmented"),]
